...
class TestRuleClass:
    ...
    def test_create_rule_failed(self, test_client: TestClient, monkeypatch):
        ...
        def mockReturn(arg1, arg2, arg3):
            return None

        monkeypatch.setattr(RuleService, "create", mockReturn)
    ...
    def test_update_rule(self, test_client: TestClient):
        ...
        res = test_client.patch(f"/rule/{json['id']}",
                                json={
                                    "name": "foo2",
                                    "position": "Tainan2",
                                    "resource": "water2",
    ...
    def test_update_rule_failed(
        ...
        res = test_client.patch(f"/rule/999",
                                json={
                                    "name": "foo2",
                                    "position": "Tainan2",
                                    "resource": "water2",
